...
const ProjetForm = ({ itemId = null, onClose, onItemCreated, onItemUpdated, baseApiUrl = 'http://localhost:8000/api' }) => {
    ...
    const [currentEngagement, setCurrentEngagement] = useState({ partenaire: null, montant_engage: '', date_engagement: '', commentaire: '' });
...
const extractArray = (response, key) => {
    ...
    useEffect(() => {
        ...
        const fetchProjetData = async () => {
            ...
            setEngagementErrors({}); 
            setEngagementsList([]);
            setCurrentEngagement({partenaire: null, montant_engage: '', date_engagement: '',  commentaire: ''});
    ...
    const validateForm = () => {
        ...
        if (!formData.Nom_Projet?.trim()) errors.Nom_Projet = "Intitulé Projet requis."; 
    ...
    */
    ...
    const handleSubmit = (e) => { 
        ...
        const dataToSubmit = { 
            ...
            Id_Programme: parseInt(formData.programme?.label.split('-')[0].trim() ) ?? null, 
